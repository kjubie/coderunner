...
namespace FHTW.CodeRunner.Migrations.Migrations
{
    ...
    [Migration("20210128153330_addedTemporaryFlag")]
    partial class addedTemporaryFlag
    {
            ...
            modelBuilder.Entity("FHTW.CodeRunner.DataAccess.Entities.ExerciseBody", b =>
                {
                    ...
                    b.Property<int>("ObtainablePoints")
                        .HasColumnType("integer")
                        .HasColumnName("obtainable_points");
            ...
            modelBuilder.Entity("FHTW.CodeRunner.DataAccess.Entities.ExerciseVersion", b =>
                {
                    ...
                    b.Property<bool>("TemporaryFlag")
                        .HasColumnType("boolean")
                        .HasColumnName("temporary_flag");

                    b.Property<int>("ValidState")
                        .HasColumnType("integer")
                        .HasColumnName("valid_state");
            ...
            modelBuilder.Entity("FHTW.CodeRunner.DataAccess.Entities.QuestionType", b =>
                {
                    ...
                    b.Property<int>("FkProgrammingLanuageId")
                        .HasColumnType("integer")
                        .HasColumnName("fk_programming_language_id");
                    ...
                    b.HasIndex("FkProgrammingLanuageId");
            ...
            modelBuilder.Entity("FHTW.CodeRunner.DataAccess.Entities.TestSuite", b =>
                {
                    ...
                    b.Property<int>("GeneralFeedbackDisplay")
                        .HasColumnType("integer")
                        .HasColumnName("feedback_display");

                    b.Property<string>("GlobalExtraParam")
                        .HasColumnType("text")
                        .HasColumnName("global_extra_param");

                    b.Property<int>("PreCheck")
                        .HasColumnType("integer")
                        .HasColumnName("precheck");
            ...
            modelBuilder.Entity("FHTW.CodeRunner.DataAccess.Entities.QuestionType", b =>
                {
                    b.HasOne("FHTW.CodeRunner.DataAccess.Entities.ProgrammingLanguage", "FkProgrammingLanguage")
                        .WithMany()
                        .HasForeignKey("FkProgrammingLanuageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
